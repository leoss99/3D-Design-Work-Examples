...
const a = loadAndPlaceOBJ('obj/armadillo.obj', armadilloMaterial, armadilloFrame, function (armadillo) {
...
function checkKeyboard() {
  ...
  armadilloFrame.position.z += 0.1;
  else if (keyboard.pressed("S"))
  armadilloFrame.position.z -= 0.1;

  if (keyboard.pressed("A"))
  armadilloFrame.position.x += 0.1;
  else if (keyboard.pressed("D"))
  armadilloFrame.position.x -= 0.1;

  if (keyboard.pressed("Q"))
  armadilloFrame.rotation.y  -= 0.1;
